...
const Craeteform = () => {
  ...
  const handleImage = async (e: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const response =  fetch("/api/verify-image", {
        method:"POST",
        body:JSON.stringify({
        address: account,
      ...
      console.log("llllllljio");
      console.log(res)
      // const data1= await response.json()
      // console.log(data1);
      // console.log("kiooooo")
      debugger
      const data = await res.json() as unknown as PinataRes;
    ...
    try {
      ...
      const reonse =  fetch("/api/verify", 
         { method:"POST",
          ...
          const data = await res.json() as PinataRes;
